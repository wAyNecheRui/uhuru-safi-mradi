            ...
            <div className="space-y-6 sm:space-y-8 order-2 lg:order-1">
                  ...
                  <div className="space-y-4 sm:space-y-6">
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <div className="text-slate-600 text-sm sm:text-base">+254 700 123 456</div>
                      </div>
                    </div>
                    <div className="flex items-center space-x-4">
              ...
              <div className="bg-white rounded-xl shadow-sm p-6 sm:p-8 mx-4 lg:mx-0">
                <div className="bg-emerald-50 rounded-lg p-4 sm:p-6">
                  <h3 className="text-lg sm:text-xl font-semibold text-slate-900 mb-4">Support Hours</h3>
                  <div className="space-y-3">
                    <div className="flex justify-between items-center">
                      <span className="text-slate-600 text-sm sm:text-base">Monday - Friday</span>
                      <span className="text-slate-900 font-medium text-sm sm:text-base">8:00 AM - 6:00 PM EAT</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-slate-600 text-sm sm:text-base">Saturday</span>
                      <span className="text-slate-900 font-medium text-sm sm:text-base">9:00 AM - 1:00 PM EAT</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-slate-600 text-sm sm:text-base">Sunday</span>
                      <span className="text-slate-900 font-medium text-sm sm:text-base">Closed</span>
                    </div>
                  </div>
                </div>
              </div>
