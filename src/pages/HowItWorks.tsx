    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-slate-900 mb-6">How Uhuru Safi Works</h1>
        ...
        <div className="bg-white rounded-xl shadow-sm p-8 mb-12">
          <div className="bg-gradient-to-r from-blue-50 to-emerald-50 rounded-lg p-6">
            <h2 className="text-2xl font-semibold text-slate-900 mb-3">Transparent Government Project Delivery</h2>
              ...
              <div key={index} className="bg-white rounded-xl shadow-sm p-8">
                <div className="flex items-start space-x-6">
                  <div className="flex-shrink-0">
                    <div className="w-16 h-16 bg-gradient-to-br from-slate-600 to-blue-600 rounded-full flex items-center justify-center mb-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-slate-700 mb-6 text-lg">{step.description}</p>
        ...
        <div className="bg-white rounded-xl shadow-sm p-8 mb-12">
          <div className="bg-amber-50 rounded-lg p-8">
            <h2 className="text-2xl font-semibold text-slate-900 mb-6 text-center">Key Benefits</h2>
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                <div className="w-16 h-16 bg-emerald-500 rounded-full flex items-center justify-center mx-auto mb-4">
                  <CheckCircle className="w-8 h-8 text-white" />
                </div>
                <h3 className="text-xl font-semibold text-slate-900 mb-2">Increased Transparency</h3>
                <p className="text-slate-600">Real-time project tracking and fund visibility</p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 bg-blue-500 rounded-full flex items-center justify-center mx-auto mb-4">
                  <Users className="w-8 h-8 text-white" />
                </div>
                <h3 className="text-xl font-semibold text-slate-900 mb-2">Community Empowerment</h3>
                <p className="text-slate-600">Direct citizen participation in governance</p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 bg-purple-500 rounded-full flex items-center justify-center mx-auto mb-4">
                  <DollarSign className="w-8 h-8 text-white" />
                </div>
                <h3 className="text-xl font-semibold text-slate-900 mb-2">Guaranteed Payments</h3>
                <p className="text-slate-600">Secure escrow system for contractors</p>
              </div>
            </div>
          </div>
        </div>
