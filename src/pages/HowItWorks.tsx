      ...
      <main>
        <ResponsiveContainer className="py-8 sm:py-12">
          <div className="text-center mb-8 sm:mb-12">
            <h1 className="text-3xl sm:text-4xl font-bold text-foreground mb-4 sm:mb-6">How Uhuru Safi Works</h1>
          ...
          {/* Process Overview */}
          <div className="bg-card rounded-xl shadow-sm p-6 sm:p-8 mb-8 sm:mb-12 mx-4 sm:mx-0">
            <div className="bg-gradient-to-r from-primary/5 to-success/10 rounded-lg p-4 sm:p-6">
              <h2 className="text-xl sm:text-2xl font-semibold text-foreground mb-3">Transparent Government Project Delivery</h2>
          ...
          <div className="space-y-6 sm:space-y-8 mb-8 sm:mb-12">
            {steps.map((step, index) => {
              ...
              return (
                <div key={index} className="bg-card rounded-xl shadow-sm p-6 sm:p-8 mx-4 sm:mx-0">
                  <div className="flex flex-col sm:flex-row items-start space-y-4 sm:space-y-0 sm:space-x-6">
                    <div className="flex-shrink-0 w-full sm:w-auto text-center sm:text-left">
                      <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-foreground to-primary rounded-full flex items-center justify-center mb-3 mx-auto sm:mx-0">
                    ...
                    <div className="flex-1 text-center sm:text-left">
                      <h3 className="text-xl sm:text-2xl font-semibold text-foreground mb-3">{step.title}</h3>
                      <p className="text-foreground/80 mb-4 sm:mb-6 text-base sm:text-lg leading-relaxed">{step.description}</p>
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        {step.details.map((detail, detailIndex) => (
                          <div key={detailIndex} className="flex items-center space-x-2 justify-center sm:justify-start">
                            <div className="w-2 h-2 bg-primary rounded-full flex-shrink-0"></div>
                            <span className="text-muted-foreground text-sm sm:text-base">{detail}</span>
                          </div>
                        ))}
                      </div>
                    </div>
          ...
          {/* Benefits Section */}
          <div className="bg-card rounded-xl shadow-sm p-6 sm:p-8 mb-8 sm:mb-12 mx-4 sm:mx-0">
            <div className="bg-warning/10 rounded-lg p-6 sm:p-8">
              <h2 className="text-xl sm:text-2xl font-semibold text-foreground mb-6 text-center">Key Benefits</h2>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
                <div className="text-center">
                  <div className="w-12 h-12 sm:w-16 sm:h-16 bg-success rounded-full flex items-center justify-center mx-auto mb-4">
                    <CheckCircle className="w-6 h-6 sm:w-8 sm:h-8 text-success-foreground" />
                  </div>
                  <h3 className="text-lg sm:text-xl font-semibold text-foreground mb-2">Increased Transparency</h3>
                  <p className="text-muted-foreground text-sm sm:text-base">Real-time project tracking and fund visibility</p>
                </div>
                <div className="text-center">
                  ...
                  <h3 className="text-lg sm:text-xl font-semibold text-foreground mb-2">Community Empowerment</h3>
                  <p className="text-muted-foreground text-sm sm:text-base">Direct citizen participation in governance</p>
                </div>
                <div className="text-center">
                  <div className="w-12 h-12 sm:w-16 sm:h-16 bg-accent rounded-full flex items-center justify-center mx-auto mb-4">
                    <Wallet className="w-6 h-6 sm:w-8 sm:h-8 text-accent-foreground" />
                  </div>
                  <h3 className="text-lg sm:text-xl font-semibold text-foreground mb-2">Guaranteed Payments</h3>
                  <p className="text-muted-foreground text-sm sm:text-base">Secure escrow system for contractors</p>
                </div>
              </div>
            </div>
          </div>
