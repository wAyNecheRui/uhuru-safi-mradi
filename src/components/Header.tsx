      ...
      <div className="container mx-auto px-4 py-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            <div className="w-12 h-12 bg-gradient-to-br from-slate-600 to-blue-600 rounded-lg flex items-center justify-center">
          ...
          <div className="flex items-center space-x-4">
            ...
            <Badge variant="outline" className="bg-gradient-to-r from-slate-50 to-blue-50 text-blue-700 border-blue-200">
