...
export const routeConfigs: RouteConfig[] = [
  ...
  { path: '/government/payments', component: 'GovernmentPaymentTransparency', roles: ['government', 'admin'], title: 'Payment Audit' },
  { path: '/government/withdrawals', component: 'GovernmentWithdrawals', roles: ['government', 'admin'], title: 'Withdrawals Queue' },
